...
EVENT_TICK = 'eContract'
EVENT_LOGBAR = 'eBarLog'
EVENT_ORDER = 'eOrder'
EVENT_POSITION = 'ePosition'
EVENT_ORDERCOMMAND = 'eOrderCommand'
EVENT_TRADE = 'e_Trade'
EVENT_ERROR = 'eOrderError'  # 记录错误委托信息
...
EVENT_SHOWCOMMAND = 'EVENT_SHOWCOMMAND'
EVENT_ORDERPARK = 'event_orderpark'
EVENT_POSITION = 'event_showposition'
EVENT_LOGIN = 'event_Login'
EVENT_ACCOUNTPOSITION = 'event_allposition'
EVENT_ORDERMARKET = 'event_marketorder'
