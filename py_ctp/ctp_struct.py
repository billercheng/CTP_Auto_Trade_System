...
class  CThostFtdcOrderField(Structure):
    ...
    @property
    def __dict__(self):
        return {'BrokerID': str(self.BrokerID, 'GBK'), 'InvestorID': str(self.InvestorID, 'GBK'), 'InstrumentID': str(self.InstrumentID, 'GBK'), 'OrderRef': str(self.OrderRef, 'GBK'), 'UserID': str(self.UserID, 'GBK'),
                'OrderPriceType': TThostFtdcOrderPriceTypeType(ord(self.OrderPriceType)) if ord(self.OrderPriceType) in [e.value for e in list(TThostFtdcOrderPriceTypeType)] else list(TThostFtdcOrderPriceTypeType)[0], 'Direction': TThostFtdcDirectionType(ord(self.Direction)) if ord(self.Direction) in [e.value for e in list(TThostFtdcDirectionType)] else list(TThostFtdcDirectionType)[0],
                'CombOffsetFlag': str(self.CombOffsetFlag, 'GBK'), 'CombHedgeFlag': str(self.CombHedgeFlag, 'GBK'), 'LimitPrice': self.LimitPrice, 'VolumeTotalOriginal': self.VolumeTotalOriginal,
                'TimeCondition': TThostFtdcTimeConditionType(ord(self.TimeCondition)) if ord(self.TimeCondition) in [e.value for e in list(TThostFtdcTimeConditionType)] else list(TThostFtdcTimeConditionType)[0], 'GTDDate': str(self.GTDDate, 'GBK'),
                'VolumeCondition': TThostFtdcVolumeConditionType(ord(self.VolumeCondition)) if ord(self.VolumeCondition) in [e.value for e in list(TThostFtdcVolumeConditionType)] else list(TThostFtdcVolumeConditionType)[0], 'MinVolume': self.MinVolume,
                'ContingentCondition': TThostFtdcContingentConditionType(ord(self.ContingentCondition)) if ord(self.ContingentCondition) in [e.value for e in list(TThostFtdcContingentConditionType)] else list(TThostFtdcContingentConditionType)[0], 'StopPrice': self.StopPrice,
                'ForceCloseReason': TThostFtdcForceCloseReasonType(ord(self.ForceCloseReason)) if ord(self.ForceCloseReason) in [e.value for e in list(TThostFtdcForceCloseReasonType)] else list(TThostFtdcForceCloseReasonType)[0], 'IsAutoSuspend': self.IsAutoSuspend, 'BusinessUnit': str(self.BusinessUnit, 'GBK'),
                'RequestID': self.RequestID, 'OrderLocalID': str(self.OrderLocalID, 'GBK'), 'ExchangeID': str(self.ExchangeID, 'GBK'), 'ParticipantID': str(self.ParticipantID, 'GBK'), 'ClientID': str(self.ClientID, 'GBK'),
                'ExchangeInstID': str(self.ExchangeInstID, 'GBK'), 'TraderID': str(self.TraderID, 'GBK'), 'InstallID': self.InstallID,
                'OrderSubmitStatus': TThostFtdcOrderSubmitStatusType(ord(self.OrderSubmitStatus)) if ord(self.OrderSubmitStatus) in [e.value for e in list(TThostFtdcOrderSubmitStatusType)] else list(TThostFtdcOrderSubmitStatusType)[0], 'NotifySequence': self.NotifySequence, 'TradingDay': str(self.TradingDay, 'GBK'),
                'SettlementID': self.SettlementID, 'OrderSysID': str(self.OrderSysID, 'GBK'), 'OrderSource': TThostFtdcOrderSourceType(ord(self.OrderSource)) if ord(self.OrderSource) in [e.value for e in list(TThostFtdcOrderSourceType)] else list(TThostFtdcOrderSourceType)[0],
                'OrderStatus': TThostFtdcOrderStatusType(ord(self.OrderStatus)) if ord(self.OrderStatus) in [e.value for e in list(TThostFtdcOrderStatusType)] else list(TThostFtdcOrderStatusType)[0], 'OrderType': TThostFtdcOrderTypeType(ord(self.OrderType)) if ord(self.OrderType) in [e.value for e in list(TThostFtdcOrderTypeType)] else list(TThostFtdcOrderTypeType)[0],'VolumeTraded': self.VolumeTraded,
                'VolumeTotal': self.VolumeTotal, 'InsertDate': str(self.InsertDate, 'GBK'), 'InsertTime': str(self.InsertTime, 'GBK'), 'ActiveTime': str(self.ActiveTime, 'GBK'), 'SuspendTime': str(self.SuspendTime, 'GBK'),
                'UpdateTime': str(self.UpdateTime, 'GBK'), 'CancelTime': str(self.CancelTime, 'GBK'), 'ActiveTraderID': str(self.ActiveTraderID, 'GBK'), 'ClearingPartID': str(self.ClearingPartID, 'GBK'),
                'SequenceNo': self.SequenceNo, 'FrontID': self.FrontID, 'SessionID': self.SessionID, 'UserProductInfo': str(self.UserProductInfo, 'GBK'), 'StatusMsg': str(self.StatusMsg, 'GBK'), 'UserForceClose': self.UserForceClose,
                'ActiveUserID': str(self.ActiveUserID, 'GBK'), 'BrokerOrderSeq': self.BrokerOrderSeq, 'RelativeOrderSysID': str(self.RelativeOrderSysID, 'GBK'), 'ZCETotalTradedVolume': self.ZCETotalTradedVolume,
                'IsSwapOrder': self.IsSwapOrder, 'BranchID': str(self.BranchID, 'GBK'), 'InvestUnitID': str(self.InvestUnitID, 'GBK'), 'AccountID': str(self.AccountID, 'GBK'), 'CurrencyID': str(self.CurrencyID, 'GBK'),
                'IPAddress': str(self.IPAddress, 'GBK'), 'MacAddress': str(self.MacAddress, 'GBK')}
...
class  CThostFtdcTradeField(Structure):
    ...
    def __dict__(self):
        return {'BrokerID': str(self.BrokerID, 'GBK'), 'InvestorID': str(self.InvestorID, 'GBK'), 'InstrumentID': str(self.InstrumentID, 'GBK'), 'OrderRef': str(self.OrderRef, 'GBK'), 'UserID': str(self.UserID, 'GBK'),
                'ExchangeID': str(self.ExchangeID, 'GBK'), 'TradeID': str(self.TradeID, 'GBK'), 'Direction': TThostFtdcDirectionType(ord(self.Direction)) if ord(self.Direction) in [e.value for e in list(TThostFtdcDirectionType)] else list(TThostFtdcDirectionType)[0], 'OrderSysID': str(self.OrderSysID, 'GBK'),
                'ParticipantID': str(self.ParticipantID, 'GBK'), 'ClientID': str(self.ClientID, 'GBK'), 'TradingRole': TThostFtdcTradingRoleType(ord(self.TradingRole)) if ord(self.TradingRole) in [e.value for e in list(TThostFtdcTradingRoleType)] else list(TThostFtdcTradingRoleType)[0],
                'ExchangeInstID': str(self.ExchangeInstID, 'GBK'), 'OffsetFlag': TThostFtdcOffsetFlagType(ord(self.OffsetFlag)) if ord(self.OffsetFlag) in [e.value for e in list(TThostFtdcOffsetFlagType)] else list(TThostFtdcOffsetFlagType)[0],
                'HedgeFlag': TThostFtdcHedgeFlagType(ord(self.HedgeFlag)) if ord(self.HedgeFlag) in [e.value for e in list(TThostFtdcHedgeFlagType)] else list(TThostFtdcHedgeFlagType)[0], 'Price': self.Price, 'Volume': self.Volume, 'TradeDate': str(self.TradeDate, 'GBK'), 'TradeTime': str(self.TradeTime, 'GBK'),
                'TradeType': TThostFtdcTradeTypeType(ord(self.TradeType)) if ord(self.TradeType) in [e.value for e in list(TThostFtdcTradeTypeType)] else list(TThostFtdcTradeTypeType)[0], 'PriceSource': TThostFtdcPriceSourceType(ord(self.PriceSource)) if ord(self.PriceSource) in [e.value for e in list(TThostFtdcPriceSourceType)] else list(TThostFtdcPriceSourceType)[0],
                'TraderID': str(self.TraderID, 'GBK'), 'OrderLocalID': str(self.OrderLocalID, 'GBK'), 'ClearingPartID': str(self.ClearingPartID, 'GBK'), 'BusinessUnit': str(self.BusinessUnit, 'GBK'),
                'SequenceNo': self.SequenceNo, 'TradingDay': str(self.TradingDay, 'GBK'), 'SettlementID': self.SettlementID, 'BrokerOrderSeq': self.BrokerOrderSeq,
                'TradeSource': TThostFtdcTradeSourceType(ord(self.TradeSource)) if ord(self.TradeSource) in [e.value for e in list(TThostFtdcTradeSourceType)] else list(TThostFtdcTradeSourceType)[0]}
