...
class TdApi:
    ...
    def onRtnOrder(self, data):
        # 常规报单事件
        print('theOrderRef')
        print(data.getBrokerID())
        print(data.getInvestorID())
        print(data.getInstrumentID())
        print(data.getOrderRef())
        print(data.getVolumeTotalOriginal())
